...
andProgressBlock:(fileDownloadProgressBlock)progressBlock {
    if ([request.type isEqualToString:@"video"]) {
        ...
        [[self.bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:url
                                                    size:CGSizeZero
                                                   scale:1
                                                 clipped:YES
                                              resizeMode:RCTResizeModeStretch
...
-(RCTImageLoaderCancellationBlock) loadImageWithURLRequest:(NSURLRequest *)imageURLRequest
    ...
    return [[self.bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[NSURLRequest requestWithURL:components.URL]
                                                size:size
                                               scale:scale
                                             clipped:clipped
